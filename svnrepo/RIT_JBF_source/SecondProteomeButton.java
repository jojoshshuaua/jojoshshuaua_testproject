 ...
 */
public class SecondProteomeButton extends Canvas implements MouseListener {
     ...
     */
    public SecondProteomeButton(Electro2D e) {
	...
	bufferGraphics.drawString("Compare Proteins", 9, 14);
	...
	//electro2D.showStatus("Load second proteome data.");
    }
