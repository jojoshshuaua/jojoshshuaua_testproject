 ...
 */
public class PeptideGenButton extends Canvas implements MouseListener {
    ...
    private PeptideGenUI pgUi = null;
     ...
     */
    public PeptideGenButton(Electro2D e, String seq, String nm) {
	...
	bufferGraphics.drawString("Generate Peptides", 9, 14);
    ...
    public void mouseClicked(MouseEvent e) {
		//open the peptide frame
		pgUi = new PeptideGenUI( aaSequence, proteinName );
    }
