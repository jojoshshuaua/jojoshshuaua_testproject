...
/**
 * Generates an HTML document for the data contained in the proteome file.
 * The page will list the max and min MW's and pI values.
 *
 ...
 *
 */
public class GenPageButton extends Canvas implements MouseListener {
     ...
     */
    public GenPageButton( Electro2D e ) {
	...
	bufferGraphics.drawString("Generate HTML", 8, 14);
